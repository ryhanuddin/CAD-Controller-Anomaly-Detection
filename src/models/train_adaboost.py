...
def main():
    parser = argparse.ArgumentParser(description="Train AdaBoostClassifier for CAD")
    parser.add_argument("--data", default="data/processed/controller_identification_dataset_extended.csv")
    parser.add_argument("--output", default="results/model_outputs/adaboost_cad_model.joblib")
